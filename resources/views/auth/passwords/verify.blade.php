          ...
          <div class="auth-inner row m-0">
            ...
            <div class="d-none d-lg-flex col-lg-8  p-0">
              <div class="w-100 d-lg-flex justify-content-center p-0">
                  <img class="img-fluid" src="{{ secure_asset('app-assets/images/pages/forgot-password-v2.png') }}" alt="Verify V2" />
              </div>
          </div>
            <!-- /Left Text-->
            <!-- verify email v2-->
              ...
              <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                <div class="shadow p-2 mb-1 bg-white rounded">
                  <div class="col-6 col-sm-6 col-md-3">
                    ...
                    <p class="card-text mb-2">{{ __('Before proceeding, please check your email for a verification link.') }}
                    ...
                    @endif
                    <p class="text-center mt-2"><span>{{__('Did not receive an email?')}}</span>
                        <form class="d-inline" method="POST" action="{{ route('verification.resend') }}">
                            @csrf
                            <div align="right">
                              <button type="submit" class="btn btn-primary w-5">{{ __('click here to request another') }}</button>
                            </div>
