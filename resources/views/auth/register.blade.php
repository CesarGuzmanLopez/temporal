                ...
                <div class="auth-inner row m-0">
                    ...
                    <div class="d-none d-lg-flex col-lg-8  p-0">
                        <div class="w-100 d-lg-flex justify-content-center p-0">
                            <img class="img-fluid" src="{{ secure_asset('app-assets/images/pages/register-v2.png') }}" alt="Register V2" />
                            ...
                            <div class="shadow p-2 mb-1 bg-white rounded">
                                    ...
                                    <form class="auth-register-form mt-2" action="{{ route('register.post') }}" method="POST">
                                        ...
                                        <div class="mb-1">
                                            ...
                                            <input class="form-control @error('email') is-invalid @enderror" id="register-email" type="text" name="email" placeholder="{{ __('Email') }}" aria-describedby="email" tabindex="2" value="{{ old('email') }}"/>
                                            @error('email')
                                        ...
                                        <div class="mb-1">
                                            ...
                                            <div class="input-group input-group-merge form-password-toggle @error('password') is-invalid @enderror">
                                                <input class="form-control form-control-merge @error('password') is-invalid @enderror" id="register-password" type="password" name="password" placeholder="{{ __('Password') }}" aria-describedby="password" tabindex="3" /><span class="input-group-text cursor-pointer"><i data-feather="eye"></i></span>
                                            </div>
                                            @error('password')
                                                <span class="invalid-feedback" role="alert">
                                                    <span>{{ $message }}</span>
                                        ...
                                        <div class="mb-1">
                                            ...
                                            <div class="input-group input-group-merge form-password-toggle @error('password_confirmation') is-invalid @enderror">
                                                <input class="form-control form-control-merge @error('password_confirmation') is-invalid @enderror" id="register-password-confirmation" type="password" name="password_confirmation" placeholder="{{ __('Confirm Password') }}" aria-describedby="confirmation" tabindex="3" /><span class="input-group-text cursor-pointer"><i data-feather="eye"></i></span>
                                        ...
                                        @endif
                                        <div align="right">
                                            <button type="submit" class="btn btn-primary w-50 pull-right" tabindex="5">{{ __('Sign up') }}</button>
                                        </div>
                                    </form>
                                </div><!--fin box-shadow-->
                            <p class="text-center mt-2"><span>{{ __('Already have an account?') }}</span><a href="{{ route('login') }}"><span>&nbsp;{{ __('Login')}}</span></a></p>
                            
                            {{-- <div class="text-center my-2">
                                <div class="divider-text">{{ __('or')}}&nbsp;{{ __('sign up with')}}</div>
                            </div>
                            
                            <div class="auth-footer-btn d-flex justify-content-center">
                                <a class="btn" href="{{ route('login.mee') }}"><img src="{{ secure_asset('app-assets/images/icons/ico_mee.png')}}" alt="Facebook" class="img_rs"></a>
