...
<div class="col-8 col-sm-8 col-md-6 col-lg-8 px-xl-2 mx-auto">
   ...
   <p><strong> Estimado usuario: {{ $email }} </strong></p> 
    ...
    <p>Hemos recibido su solicitud de recuperación de contraseña de su cuenta en Servicios Macmillan Latam..</p>

    <p>Por favor, haga clic en el botón de abajo para introducir su nueva contraseña</p>

    <div class="col-10 col-sm-12 col-md-8 col-lg-6 mx-auto">
        <a href="{{ url('/restore/password/' . $confirmation_code.'') }}" class="btn btn-primary" role="button" >
       Cambiar contraseña
        </a>
    </div></br>
